...
<div class="list-results">
                                <div class="row" id="grouplist">
                                    <c:forEach items="${requestScope.myGroupListGrid}" var="myGroupListGrid">
                        ...
                        <ul>
                           ...
                           <li class="item-date">현재인원/${myGroupListGrid.gCount }</li>
                        </ul>


                        <ul>
                           <li class="item-type"><i class="fa fa-comment-o"></i> 소개</li><br>
                           <li class="item-type">${myGroupListGrid.gInfo }</li>
                        </ul>
                     </div>
