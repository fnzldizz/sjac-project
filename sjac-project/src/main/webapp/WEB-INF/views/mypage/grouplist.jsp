...
<div class="search-results-box">
   <div class="row">
      <div class="col-md-12 search-results">
         menu : <span>"나의 그룹 리스트"</span> Results : <span>그룹개수</span>
         groups
      </div>
   </div>
</div>
...
<div class="list-results">
                                <div class="row" id ="grouplist" >
                                  <c:forEach items="${requestScope.myGroupList}" var="groupList">
                                    ...
                                    <!-- 사진 -->
                                                    <div class="item-img">
                                                       <img alt="" src="${groupList.subjectVO.categoryImg}">
                                                    </div>
                                    <!-- 사진 -->
                                                </div>
                                                ...
                                                <div class="col-sm-8 col-xs-6">
                                                    <div class="item-title">
                                                       <h4>${groupList.gName}</h4>
                                                    </div>
                                                    <div class="item-meta">
                                                        <ul>
                                                            <li class="item-date"><i class="fa fa-comment-o"></i> ${groupList.gInfo }</li>
                                                            <li class="item-cat hidden-xs"><i class="fa fa-bars"></i> ${groupList.subjectVO.subjectCategory} , ${groupList.subjectVO.subject}</li>
                                                            <li class="item-location hidden-xs"><i class="fa fa-map-marker"></i> ${groupList.gLocation}</li>
                                                            <li class="item-type"><i class="fa fa-user"></i> 현재인원/${groupList.gCount }</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <!-- 그룹정보 끝 -->
